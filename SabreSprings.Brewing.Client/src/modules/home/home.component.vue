        ...
        <div class="row">
            <div class="col">
                <div class=" text-center">
                    <h1 ><i :class="appIcon"></i> Sabre Springs Brewing</h1>
                    <div class="action-container text-left d-inline-block">
                        <div id="applicationName" class="mb-2">Automated Brewing Control Center</div>
...
.jumbotron {
    ...
    background: -moz-linear-gradient(left, #484b50 1%, #565a5e 61%, #484b50 88%); /* FF3.6-15 */
    background: -webkit-linear-gradient(left, #484b50 1%, #565a5e 61%, #484b50 88%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to right, #484b50 1%, #565a5e 61%, #484b50 88%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
